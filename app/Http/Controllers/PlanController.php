...
class PlanController extends Controller
{
	...
	{
		return view('stripe.plan')->withPlans(Plan::all());
	}
    /**
    ...
    public function show($id)
    {
        ...
        return view('stripe.plan', compact('plan'));
    }
    ...
    public function subscribe(Request $request)
    {
		...
		return redirect()->to('profile/'.Auth::user()->name.'/edit')
			->with('status', 'You are now subscribed to ' . $pickedPlan .	' plan.');
        ...
        return redirect()->route('profile')->with('status', 'You are now subscribed to ' . $pickedPlan . ' plan.');
    }
