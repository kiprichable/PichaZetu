            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                @else
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li {{ Request::is('profile/'.Auth::user()->first_name.Auth::user()->last_name, 'profile/'.Auth::user()->first_name.Auth::user()->last_name . '/edit') ? 'class=active' : null }}>
                                {!! HTML::link(url('/profile/'.Auth::user()->first_name.Auth::user()->last_name), trans
                                ('titles.profile')) !!}
                            </li>
                            <li>	<a href="{{URL::Asset('/profile/'.Auth::user()->name.'/edit')}}"> {{trans('titles
                                    .createProfile')}}</a>
                            </li>
                            <li>
                                <a href="{{ route('logout') }}"
