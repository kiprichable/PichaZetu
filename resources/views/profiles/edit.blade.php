		...
		<div class="row">
			<ul class="nav nav-pills nav-justified margin-bottom-3">
				<li class="bg-info change-pw active">
					<a data-toggle="pill" href="#settings" class="settings-trigger">
						<span class="glyphicon glyphicon-user"></span>
					</a>
				</li>
				<li class="bg-info delete-account">
					<a data-toggle="pill" href="#account" class="admin-trigger">
			...
			<div class="tab-content">
				@if ($user->profile)
					...
					@if (Auth::user()->id == $user->id)
						<div id="settings" class="tab-pane fade in active edit_settings">
						...
						<div id="account" class="tab-pane fade edit_account">
						...
						<div id="subscription" class="tab-pane fade">
							...
							<div class="panel panel-default">
								<div class="panel-body text-center">
									@if( $is_subscribed )
										...
										<h3 class="text-success">
										 You are subscribed to the :<br>
											<small>
												<span class="text-primary">{{ $subscription->stripe_plan }}</span> plan.
											</small>
										</h3>
									...
									@else
										<h3 class="text-danger">You dont have any active subscriptions. <br>
										</h3>
									...
									@if( !empty($plans) )
										...
										@if($is_subscribed)
											<h3 class="text-danger">
												<small>You can always change your subscription by selecting any of
													the plans below.</small>
											</h3>

										@else
											<h3 class="text-danger">
											<small>Please choose any of the subscriptions below.!</small>
											</h3>
										@endif
												...
												<div class="panel {{ ( $is_subscribed && $subscription->stripe_plan ==  $plan->id ) ? 'panel-success' :  'panel-primary' }}">
													...
													<div class="panel-body text-center">
														...
														<img class="img-responsive img-thumbnail"
															 src="{{ asset('images/money.png')}}" alt="{{ $plan->name }} Coal">
														...
														<div class="panel panel-primary">
															<div class="panel-body">
																Storage
																{{\App\Models\Plan::where('name',$plan->id)->first()
																['storage']}} GB
															</div>
														</div>
														<div class="panel panel-primary">
